...
public class ClerkValidator implements TokenValidator {
    ...
    private boolean verifyTokenSignature(String token, String kid) {
        try {
            ...
            log.warn("Signature verification failed for kid {}: {}. Bypassing strict verification for local dev.", kid,
                    e.getMessage());
            // WARNING: For local debugging only. Do not do this in production.
            return true;
        }
    }
